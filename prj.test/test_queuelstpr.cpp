...
TEST_CASE("push, pop, top sorted") {
    ...
    CHECK_NOTHROW(qu.Push(two));// 2.2

    CHECK_EQ(qu.Top(), two);//2.2 == 2.2

    CHECK_NOTHROW(qu.Pop());// []

    CHECK(qu.IsEmpty());

    CHECK_NOTHROW(qu.Push(four));//4.4
    CHECK_NOTHROW(qu.Push(two));// 4.4 2.2

    CHECK_EQ(qu.Top(), two);// 2.2 == 2.2

    CHECK_NOTHROW(qu.Push(three));// 4.4 3.3 2.2

    CHECK_EQ(qu.Top(), two);//2.2 == 2.2

    CHECK_NOTHROW(qu.Pop());// 4.4 3.3

    CHECK_EQ(qu.Top(), three);// 3.3 == 3.3
